...
! function(e, t) {
    ...
    e.fn.mafia = function(i) {
        ...
        return i = !a && o.length ? e.extend.apply(null, [!0, i].concat(o)) : i, a && "_" === i.charAt(0) ? r : (a ? this.each(function() {
            var a = e(this).data("mafia"),
                n = a && e.isFunction(a[i]) ? a[i].apply(a, o) : a;
            if (n !== a && n !== t) return r = n, !1
        }) : this.each(function() {
            e(this).data("mafia", new e.mafia(this, i))
        }), r)
    }, e.mafia = function(i, a) {
        var o = i.id;
        if (arguments.length) {
            this.element = e(i), this.options = e.extend(!0, {}, this.options, a);
            var r = this;
            this.element.bind("remove.mafia", function() {
                r.destroy()
            })
        }
...
break;
        ...
        e(document).ready(function() {
            if (xt("SCRIPT FOLDER: " + (Oe = function(e) {
                    ...
                    return r
                }("mafia.min.js"))), xt("USERAGENT: " + navigator.userAgent), xt("BROWSER: " + Me.browser.name), xt("OS: " + Me.os.name), xt("usevisualizer: " + O), xt("visualizertype: " + D), xt("ismobile: " + ("mobile" == Me.device.type)), "true" == re) {
                re = "false";
                try {
                    var e = new Audio;
        ...
        function st() {
            ...
            try {
                e(".lunaaudioplayer").each(function() {
                    e(this).attr("id") != n && e(this).data("mafia").pause()
                })
            } catch (e) {
                xt(e)
            }
